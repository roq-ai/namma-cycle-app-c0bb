...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['admin', 'fleet-manager', 'station-manager', 'owner'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Cycle', path: '/cycles', entity: 'cycle', service: AccessServiceEnum.PROJECT, icon: FiRefreshCcw },
    { name: 'Station', path: '/stations', entity: 'station', service: AccessServiceEnum.PROJECT, icon: FiMapPin },
